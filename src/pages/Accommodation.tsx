...
const Accommodation: React.FC = () => {
  ...
  const accommodations: RoomType[] = [
    ...
    },
    {
      ...
      amenities: [
        { icon: <Wifi size={16} />, label: "Free Wi-Fi" },
        { icon: <Coffee size={16} />, label: "Premium Coffee" },
        { icon: <Tv size={16} />, label: "Smart TV" },
    ...
    },
    {
      ...
      amenities: [
        { icon: <Wifi size={16} />, label: "Free Wi-Fi" },
        { icon: <Coffee size={16} />, label: "Organic Tea & Coffee" },
        { icon: <Tv size={16} />, label: "Smart TV" },
        { icon: <Users size={16} />, label: "Up to 2 Guests" }
      ]
    },
    {
      ...
      amenities: [
        ...
        { icon: <Coffee size={16} />, label: "Coffee Maker" },
        { icon: <Tv size={16} />, label: "Smart TV" },
        { icon: <Users size={16} />, label: "Up to 3 Guests" }
      ]
    },
    {
      id: "luxury-tent",
      ...
      amenities: [
        { icon: <Wifi size={16} />, label: "Free Wi-Fi" },
        { icon: <Coffee size={16} />, label: "Gourmet Coffee" },
        { icon: <Tv size={16} />, label: "Bluetooth Speaker" },
        { icon: <Users size={16} />, label: "Up to 2 Guests" }
      ]
    },
    {
      ...
      amenities: [
        { icon: <Wifi size={16} />, label: "Free Wi-Fi" },
        { icon: <Coffee size={16} />, label: "Full Kitchen" },
        { icon: <Tv size={16} />, label: "Smart TV" },
        { icon: <Users size={16} />, label: "Up to 6 Guests" }
      ]
    }
  ];
        ...
        <section className="py-4 container px-4">
          <div className="flex flex-wrap justify-center gap-3 mb-12 animate-fade-in">
            {[
              ...
              { value: 'budget', label: 'Budget (Under $150)' },
              { value: 'standard', label: 'Standard ($150-$250)' },
              { value: 'luxury', label: 'Luxury (Above $250)' }
            ].map((option) => (
              <button
                key={option.value}
          ...
          {filteredAccommodations.length === 0 && (
            <div className="text-center py-12">
              ...
              <button
                ...
                className="mt-4 px-6 py-2 bg-accent text-accent-foreground rounded-md"
              >
          ...
          <div className="container px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div 
                  key={index}
                  className="rounded-xl overflow-hidden shadow-md bg-white animate-fade-in"
        ...
        <section className="py-16 bg-accent text-accent-foreground">
          <div className="container px-4 text-center">
            <div className="max-w-2xl mx-auto animate-fade-in">
              ...
              <Link 
                to="/booking" 
                className="inline-block px-8 py-4 bg-white text-accent font-medium text-lg rounded-md transition-all duration-300 hover:bg-white/90 hover:shadow-lg"
              >
                Book Now
              </Link>
            </div>
